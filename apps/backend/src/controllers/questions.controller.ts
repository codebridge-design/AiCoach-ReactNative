...
export async function nextQuestion(req: any, res: Response) {
...
export async function followUpQuestion(req: any, res: Response) {
...
export async function getQuestionBank(req: any, res: Response) {
...
export async function saveToBank(req: any, res: Response) {
